...
template <typename T>
void print_vector(const sax::Vector<T>& v){
...
void demo_vector(){
    ...
    auto vec1 = sax::Vector<double>{};
    vec1.push_back(42);

    //here vec2 is copy-constructed from vec1
    sax::Vector<double> vec2 = vec1;
    vec2.push_back(55);
...
void demo_integer(){
    ...
    Number<int> a = 2; //this uses the implicit constructor from int
    Number<int> b{3};
    std::cout << "a= " << (int)a << "\n";
